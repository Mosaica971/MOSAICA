...
if economics:
    ...
    st.caption(
        ...
        "config `baseline_representative_crops` (hypothese -- voir docs/04-vigilance.md point 4). "
    ...
    with tab:
        ...
        if side == "input":
            st.caption(
                ...
                "jamais ete observee (docs/04-vigilance.md point 4)."
            )
        for name, label in (
