...
- Scenario : mo_fin_observe
- Horodatage : 2026-09-09T14:52:18.649685+00:00
- Duree de resolution : 4046.56s
...
## Objectif
- maximize_risk_adjusted_gross_margin = 81,649,158.51
...
- Surface cultivee (ha) : 23577.99 -> 23477.20 (delta -100.79)
- Parcelles actives : 22197 -> 22039 (delta -158)
...
- Production (t) : 694,464 -> 924,002 (delta +229,538)
- Subvention (EUR) : 68,977,159 -> 74,251,661 (delta +5,274,503)
- Revenu / produit brut (EUR) : 230,992,969 -> 224,340,165 (delta -6,652,804)
- Cout variable (EUR) : 142,207,276 -> 126,309,942 (delta -15,897,334)
- Marge brute (EUR) : 88,785,693 -> 98,030,223 (delta +9,244,530)
- Cout main d'oeuvre (EUR) : 96,917,466 -> 83,281,483 (delta -13,635,982)
- Revenu net (marge brute - cout MO, EUR) : -8,131,773 -> 14,748,739 (delta +22,880,512)
- Emploi (ETP) : 3,890.9 -> 3,343.5 (delta -547.4)
...
- PAD territorial : 11.0% (seuil 15%) -> OK
- Cultures sous seuil : 4 / 11
- Cellules sous-regionales sous seuil : 19 / 70 (seuil 20%)
- Exploitations sous seuil : 3101 / 4588 (seuil 20%)
- Types d'exploitation correctement simules : 82.8% (seuil 80%) -> OK
- Parcelles avec la bonne culture : 66.6% (14790 / 22197)
- Surface avec la bonne culture : 76.7% (18,085 / 23,578 ha)
