...
- Scenario : P8_transition_agroecologique__pareto_azote__threshold=810979
- Horodatage : 2026-08-10T04:49:35.592098+00:00
- Duree de resolution : 2504.89s
...
## Objectif
- maximize_risk_adjusted_gross_margin = 63,304,370.94
...
- territory_indicator_bound {'label': 'azote_max', 'indicator': 'azote', 'sense': 'le', 'threshold': 810979}
...
- Surface cultivee (ha) : 23577.99 -> 26055.57 (delta +2477.58)
- Parcelles actives : 22197 -> 24584 (delta +2387)
...
- Production (t) : 722,094 -> 411,563 (delta -310,530)
- Subvention (EUR) : 63,046,280 -> 27,042,687 (delta -36,003,593)
- Revenu / produit brut (EUR) : 223,835,350 -> 212,896,033 (delta -10,939,317)
- Cout variable (EUR) : 142,155,073 -> 134,103,206 (delta -8,051,867)
- Marge brute (EUR) : 81,680,278 -> 78,792,827 (delta -2,887,451)
- Cout main d'oeuvre (EUR) : 96,859,669 -> 104,615,311 (delta +7,755,643)
- Revenu net (marge brute - cout MO, EUR) : -15,179,391 -> -25,822,484 (delta -10,643,093)
...
- PAD territorial : 90.6% (seuil 15%) -> HORS SEUIL
- Cultures sous seuil : 0 / 11
- Cellules sous-regionales sous seuil : 7 / 70 (seuil 20%)
- Exploitations sous seuil : 1305 / 4588 (seuil 20%)
- Types d'exploitation correctement simules : 45.3% (seuil 80%) -> HORS SEUIL
- Parcelles avec la bonne culture : 33.7% (7479 / 22197)
- Surface avec la bonne culture : 44.4% (10,475 / 23,578 ha)
