...
- Horodatage : 2026-08-12T08:22:53.585243+00:00
- Duree de resolution : 10839.08s
...
## Objectif
- maximize_risk_adjusted_gross_margin = 65,005,778.31
...
- Surface cultivee (ha) : 23577.99 -> 22292.76 (delta -1285.23)
- Parcelles actives : 22197 -> 18562 (delta -3635)
- Exploitations actives : 4588 -> 4537 (delta -51)

## Entree vs sortie (economie)
_Entree = baseline 2017 a economie representative par famille (voir docs/04-vigilance.md point 4)._
- Production (t) : 722,094 -> 709,939 (delta -12,154)
- Subvention (EUR) : 68,977,159 -> 53,375,934 (delta -15,601,225)
- Revenu / produit brut (EUR) : 229,766,229 -> 181,553,863 (delta -48,212,366)
- Cout variable (EUR) : 142,155,073 -> 103,163,846 (delta -38,991,227)
- Marge brute (EUR) : 87,611,156 -> 78,390,018 (delta -9,221,138)
- Cout main d'oeuvre (EUR) : 96,859,669 -> 70,268,502 (delta -26,591,166)
- Revenu net (marge brute - cout MO, EUR) : -9,248,513 -> 8,121,515 (delta +17,370,028)
- Emploi (ETP) : 3,888.6 -> 2,821.1 (delta -1,067.6)
...
- PAD territorial : 21.0% (seuil 15%) -> HORS SEUIL
- Cultures sous seuil : 2 / 11
- Cellules sous-regionales sous seuil : 11 / 70 (seuil 20%)
- Exploitations sous seuil : 2557 / 4588 (seuil 20%)
- Types d'exploitation correctement simules : 71.0% (seuil 80%) -> HORS SEUIL
- Parcelles avec la bonne culture : 48.5% (10770 / 22197)
- Surface avec la bonne culture : 64.3% (15,172 / 23,578 ha)
