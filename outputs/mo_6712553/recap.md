...
- Scenario : mo_6712553
- Horodatage : 2026-09-09T14:58:13.759388+00:00
- Duree de resolution : 238.72s
...
## Objectif
- maximize_risk_adjusted_gross_margin = 84,470,125.36
...
- farm_labor_hours_max {'label': 'mo_max_expl', 'slack': 1.073538}
- farm_production_bound {'label': 'ba_quota_expl', 'crops': ['BA', 'BA_INT', 'BA_IRR', 'BA_PER', 'BA_SINT'], 'reference': 'BA', 'sense': 'le', 'scale': 1.0}
...
- Surface cultivee (ha) : 23577.99 -> 23477.49 (delta -100.50)
- Parcelles actives : 22197 -> 22041 (delta -156)
...
- Production (t) : 694,464 -> 917,906 (delta +223,442)
- Subvention (EUR) : 68,977,159 -> 73,401,212 (delta +4,424,054)
- Revenu / produit brut (EUR) : 230,992,969 -> 247,621,770 (delta +16,628,801)
- Cout variable (EUR) : 142,207,276 -> 137,594,334 (delta -4,612,942)
- Marge brute (EUR) : 88,785,693 -> 110,027,436 (delta +21,241,743)
- Cout main d'oeuvre (EUR) : 96,917,466 -> 94,091,912 (delta -2,825,553)
- Revenu net (marge brute - cout MO, EUR) : -8,131,773 -> 15,935,524 (delta +24,067,296)
- Emploi (ETP) : 3,890.9 -> 3,777.5 (delta -113.4)
...
- PAD territorial : 12.9% (seuil 15%) -> OK
- Cultures sous seuil : 3 / 11
- Cellules sous-regionales sous seuil : 21 / 70 (seuil 20%)
- Exploitations sous seuil : 3011 / 4588 (seuil 20%)
- Types d'exploitation correctement simules : 80.8% (seuil 80%) -> OK
- Parcelles avec la bonne culture : 62.2% (13817 / 22197)
- Surface avec la bonne culture : 73.0% (17,213 / 23,578 ha)
