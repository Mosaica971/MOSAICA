...
- Scenario : P4_statu_quo__pareto_subventions__threshold=90000000
- Horodatage : 2026-08-10T03:04:30.329941+00:00
- Duree de resolution : 326.56s
...
## Objectif
- maximize_risk_adjusted_gross_margin = 81,036,579.53
...
- territory_indicator_bound {'label': 'budget_subventions', 'indicator': 'subvention', 'sense': 'le', 'threshold': 90000000}
...
- Surface cultivee (ha) : 23577.99 -> 26023.45 (delta +2445.46)
- Parcelles actives : 22197 -> 24561 (delta +2364)
...
- Production (t) : 722,094 -> 910,704 (delta +188,610)
- Subvention (EUR) : 68,977,159 -> 71,277,791 (delta +2,300,633)
- Revenu / produit brut (EUR) : 229,766,229 -> 227,027,982 (delta -2,738,247)
- Cout variable (EUR) : 142,207,276 -> 128,673,394 (delta -13,533,882)
- Marge brute (EUR) : 87,558,952 -> 98,354,588 (delta +10,795,636)
- Cout main d'oeuvre (EUR) : 96,917,466 -> 86,581,853 (delta -10,335,613)
- Revenu net (marge brute - cout MO, EUR) : -9,358,513 -> 11,772,735 (delta +21,131,248)
- Emploi (ETP) : 3,890.9 -> 3,476.0 (delta -414.9)
...
- PAD territorial : 6.4% (seuil 15%) -> OK
- Cultures sous seuil : 4 / 11
- Cellules sous-regionales sous seuil : 21 / 70 (seuil 20%)
- Exploitations sous seuil : 3329 / 4588 (seuil 20%)
- Types d'exploitation correctement simules : 86.5% (seuil 80%) -> OK
- Parcelles avec la bonne culture : 66.8% (14834 / 22197)
- Surface avec la bonne culture : 76.4% (18,008 / 23,578 ha)
