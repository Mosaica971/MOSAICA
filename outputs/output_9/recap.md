...
- Scenario : canne_plafond_bas
- Horodatage : 2026-07-17T09:45:00.509198+00:00
- Duree de resolution : 2383.19s
...
- territory_production_bound {'label': 'cs_quota_max', 'groups': [{'crops': ['CS', 'CS_BT_NISM', 'CS_BT_NIM', 'CS_BT_IM', 'CS_SBT_NISM', 'CS_SBT_NIM', 'CS_SBT_IM', 'CS_NGT_NISM', 'CS_NGT_NIM', 'CS_NGT_IM', 'CS_CGT_NISM', 'CS_CGT_NIM', 'CS_CGT_IM', 'CS_EGT_NISM', 'CS_EGT_NIM', 'CS_EGT_IM', 'CS_MG_NISM', 'CS_MG_NIM', 'CS_MG_IM'], 'use_yield': True, 'rate_multiplier': 0.072}], 'sense': 'le', 'threshold': 30000}
...
- Revenu / produit brut (EUR) : 228,238,871 -> 668,140,998 (delta +439,902,127)
- Cout variable (EUR) : 141,278,643 -> 342,755,409 (delta +201,476,766)
- Marge brute (EUR) : 86,960,228 -> 325,385,589 (delta +238,425,361)
- Cout main d'oeuvre (EUR) : 89,625,861 -> 301,036,501 (delta +211,410,641)
- Revenu net (marge brute - cout MO, EUR) : -2,665,632 -> 24,349,088 (delta +27,014,720)
