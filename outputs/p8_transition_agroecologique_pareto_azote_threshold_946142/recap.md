...
- Scenario : P8_transition_agroecologique__pareto_azote__threshold=946142
- Horodatage : 2026-08-10T05:51:28.615520+00:00
- Duree de resolution : 3618.31s
...
## Objectif
- maximize_risk_adjusted_gross_margin = 65,780,393.04
...
- territory_indicator_bound {'label': 'azote_max', 'indicator': 'azote', 'sense': 'le', 'threshold': 946142}
...
- Surface cultivee (ha) : 23577.99 -> 26066.64 (delta +2488.65)
- Parcelles actives : 22197 -> 24605 (delta +2408)
...
- Production (t) : 722,094 -> 468,144 (delta -253,949)
- Subvention (EUR) : 63,046,280 -> 32,868,515 (delta -30,177,765)
- Revenu / produit brut (EUR) : 223,835,350 -> 216,149,203 (delta -7,686,147)
- Cout variable (EUR) : 142,155,073 -> 136,244,342 (delta -5,910,731)
- Marge brute (EUR) : 81,680,278 -> 79,904,861 (delta -1,775,416)
- Cout main d'oeuvre (EUR) : 96,859,669 -> 104,617,755 (delta +7,758,086)
- Revenu net (marge brute - cout MO, EUR) : -15,179,391 -> -24,712,893 (delta -9,533,502)
- Emploi (ETP) : 3,888.6 -> 4,200.1 (delta +311.5)
...
- PAD territorial : 80.1% (seuil 15%) -> HORS SEUIL
- Cultures sous seuil : 0 / 11
- Cellules sous-regionales sous seuil : 9 / 70 (seuil 20%)
- Exploitations sous seuil : 1339 / 4588 (seuil 20%)
- Types d'exploitation correctement simules : 46.9% (seuil 80%) -> HORS SEUIL
- Parcelles avec la bonne culture : 36.0% (7999 / 22197)
- Surface avec la bonne culture : 48.5% (11,424 / 23,578 ha)
