...
- Scenario : pareto_azote__threshold=1737813
- Horodatage : 2026-08-04T21:42:34.930095+00:00
- Duree de resolution : 183.83s
...
## Objectif
- maximize_risk_adjusted_gross_margin = 79,754,235.79
...
- territory_indicator_bound {'label': 'azote_max', 'indicator': 'azote', 'sense': 'le', 'threshold': 1737813}

## Entree vs sortie (surface)
- Surface cultivee (ha) : 23577.99 -> 23450.58 (delta -127.41)
- Parcelles actives : 22197 -> 22019 (delta -178)
...
- Production (t) : 722,094 -> 855,511 (delta +133,417)
- Subvention (EUR) : 68,977,159 -> 65,075,696 (delta -3,901,462)
- Revenu / produit brut (EUR) : 229,766,229 -> 223,758,839 (delta -6,007,390)
- Cout variable (EUR) : 142,207,276 -> 124,438,267 (delta -17,769,009)
- Marge brute (EUR) : 87,558,952 -> 99,320,571 (delta +11,761,619)
- Cout main d'oeuvre (EUR) : 96,917,466 -> 86,101,909 (delta -10,815,557)
- Revenu net (marge brute - cout MO, EUR) : -9,358,513 -> 13,218,663 (delta +22,577,176)
- Emploi (ETP) : 3,890.9 -> 3,456.7 (delta -434.2)
...
- PAD territorial : 16.2% (seuil 15%) -> HORS SEUIL
- Cultures sous seuil : 2 / 11
- Cellules sous-regionales sous seuil : 19 / 70 (seuil 20%)
- Exploitations sous seuil : 3334 / 4588 (seuil 20%)
- Types d'exploitation correctement simules : 84.1% (seuil 80%) -> OK
- Parcelles avec la bonne culture : 65.2% (14480 / 22197)
- Surface avec la bonne culture : 73.9% (17,436 / 23,578 ha)
