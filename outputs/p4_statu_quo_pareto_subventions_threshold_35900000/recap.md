...
- Scenario : P4_statu_quo__pareto_subventions__threshold=35900000
- Horodatage : 2026-08-05T22:15:58.998087+00:00
- Duree de resolution : 1322.47s
...
## Objectif
- maximize_risk_adjusted_gross_margin = 74,357,645.98
...
- territory_indicator_bound {'label': 'budget_subventions', 'indicator': 'subvention', 'sense': 'le', 'threshold': 35900000}
...
- Surface cultivee (ha) : 23577.99 -> 25578.81 (delta +2000.82)
- Parcelles actives : 22197 -> 24207 (delta +2010)
...
- Production (t) : 722,094 -> 774,510 (delta +52,416)
- Subvention (EUR) : 68,977,159 -> 35,898,271 (delta -33,078,888)
- Revenu / produit brut (EUR) : 229,766,229 -> 227,212,163 (delta -2,554,066)
- Cout variable (EUR) : 142,207,276 -> 114,284,677 (delta -27,922,599)
- Marge brute (EUR) : 87,558,952 -> 112,927,486 (delta +25,368,533)
- Cout main d'oeuvre (EUR) : 96,917,466 -> 84,688,966 (delta -12,228,500)
- Revenu net (marge brute - cout MO, EUR) : -9,358,513 -> 28,238,520 (delta +37,597,033)
...
- PAD territorial : 36.5% (seuil 15%) -> HORS SEUIL
- Cultures sous seuil : 1 / 11
- Cellules sous-regionales sous seuil : 14 / 70 (seuil 20%)
- Exploitations sous seuil : 3014 / 4588 (seuil 20%)
- Types d'exploitation correctement simules : 78.4% (seuil 80%) -> HORS SEUIL
- Parcelles avec la bonne culture : 57.2% (12706 / 22197)
- Surface avec la bonne culture : 65.8% (15,503 / 23,578 ha)
