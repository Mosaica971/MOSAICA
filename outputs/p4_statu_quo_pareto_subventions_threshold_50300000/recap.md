...
- Scenario : P4_statu_quo__pareto_subventions__threshold=50300000
- Horodatage : 2026-08-05T23:21:18.248858+00:00
- Duree de resolution : 1636.64s
...
## Objectif
- maximize_risk_adjusted_gross_margin = 77,961,380.68
...
- territory_indicator_bound {'label': 'budget_subventions', 'indicator': 'subvention', 'sense': 'le', 'threshold': 50300000}
...
- Surface cultivee (ha) : 23577.99 -> 25952.90 (delta +2374.91)
- Parcelles actives : 22197 -> 24476 (delta +2279)
...
- Production (t) : 722,094 -> 839,123 (delta +117,029)
- Subvention (EUR) : 68,977,159 -> 50,070,701 (delta -18,906,457)
- Revenu / produit brut (EUR) : 229,766,229 -> 227,969,584 (delta -1,796,645)
- Cout variable (EUR) : 142,207,276 -> 120,594,557 (delta -21,612,720)
- Marge brute (EUR) : 87,558,952 -> 107,375,027 (delta +19,816,075)
- Cout main d'oeuvre (EUR) : 96,917,466 -> 84,999,650 (delta -11,917,816)
- Revenu net (marge brute - cout MO, EUR) : -9,358,513 -> 22,375,377 (delta +31,733,890)
- Emploi (ETP) : 3,890.9 -> 3,412.5 (delta -478.5)
...
- Exploitations sous seuil : 3363 / 4588 (seuil 20%)
- Types d'exploitation correctement simules : 83.6% (seuil 80%) -> OK
- Parcelles avec la bonne culture : 63.8% (14157 / 22197)
- Surface avec la bonne culture : 71.9% (16,946 / 23,578 ha)
