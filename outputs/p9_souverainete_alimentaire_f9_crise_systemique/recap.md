...
- Scenario : P9_souverainete_alimentaire__F9_crise_systemique
- Horodatage : 2026-08-04T01:31:51.670920+00:00
- Duree de resolution : 3032.56s
...
## Objectif
- maximize_risk_adjusted_gross_margin = 31,468,573.06
...
- Surface cultivee (ha) : 23577.99 -> 18245.03 (delta -5332.96)
- Parcelles actives : 22197 -> 19318 (delta -2879)
...
- Production (t) : 577,675 -> 180,163 (delta -397,512)
- Subvention (EUR) : 25,884,817 -> 3,578,584 (delta -22,306,233)
- Revenu / produit brut (EUR) : 143,432,973 -> 180,864,588 (delta +37,431,614)
- Cout variable (EUR) : 177,782,574 -> 213,069,511 (delta +35,286,937)
- Marge brute (EUR) : -34,349,601 -> -32,204,924 (delta +2,144,677)
- Cout main d'oeuvre (EUR) : 96,917,466 -> 128,499,942 (delta +31,582,477)
- Revenu net (marge brute - cout MO, EUR) : -131,267,066 -> -160,704,866 (delta -29,437,800)
- Emploi (ETP) : 3,890.9 -> 5,158.9 (delta +1,267.9)
...
- PAD territorial : 84.8% (seuil 15%) -> HORS SEUIL
- Cultures sous seuil : 1 / 11
- Cellules sous-regionales sous seuil : 6 / 70 (seuil 20%)
- Exploitations sous seuil : 939 / 4588 (seuil 20%)
- Types d'exploitation correctement simules : 30.9% (seuil 80%) -> HORS SEUIL
- Parcelles avec la bonne culture : 17.7% (3931 / 22197)
- Surface avec la bonne culture : 17.6% (4,155 / 23,578 ha)
