...
\begin{figure}[h]
  ...
  sont les points de comparaison. F0 est le forçage \emph{nul}, P4 le statu quo.}
  \label{fig:spectre}
\end{figure}
...
\begin{table}[h]
  ...
  \emph{hors aide} exclut les subventions de la marge brute. La dague marque un solve sous-optimal car arrêté à la limite de temps.}
  \label{tab:grille}
  \small
...
\begin{figure}[h]
  ...
  forçage. Une barre nulle correspond au meilleur choix de politique, sachant le forçage. Aucune politique n'est courte partout.}
  \label{fig:regret}
\end{figure}
...
guadeloupéen et joue un rôle important dans l'existence de la culture de canne. En revanche, le
modèle ne vérifie pas que les \SI{2237}{\ha} de maraîchage qui apparaissent trouvent un acheteur
