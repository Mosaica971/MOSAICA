...
La figure~\ref{fig:spectre} donne les deux catalogues. Elle sert à deux choses : montrer que
celui des politiques est \emph{ordonné} — d'une dérégulation complète à une rupture
agroécologique, et non pas assemblé au hasard —, et montrer d'un coup d'\oe il quelles cases
ont effectivement été calculées. Ce second point est une limite du travail, et il vaut mieux
la voir tout de suite que la découvrir au §~\ref{sec:limites}.
...
\begin{figure}[tbp]
  ...
  bifurcation non} (§~\ref{sec:limites}).}
  \label{fig:spectre}
\end{figure}
