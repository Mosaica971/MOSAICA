...
\begin{itemize}
\item La calibration dépasse les trois métriques publiées par l'article de \parencite{chopin2015}
...
\item Seulement 4 cultures sur 11 passent sous le seuil d'écart de l'article. l'erreur résiduelle
