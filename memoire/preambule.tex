...
\usepackage{textcomp}
% Le symbole euro : \euro n'existe pas avec newtx, c'est textcomp qui le fournit sous le nom
% \texteuro. NE PAS ecrire \DeclareSIUnit{\euro}{\text{\euro}} -- la definition serait
% recursive et LaTeX boucle.
\newcommand{\eur}{\texteuro}
\DeclareSIUnit{\ha}{ha}
\DeclareSIUnit{\etp}{ETP}
\DeclareSIUnit{\tonne}{t}
\DeclareSIUnit{\EUR}{\texteuro}
